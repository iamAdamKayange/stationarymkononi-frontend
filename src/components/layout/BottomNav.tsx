        ...
        {navItems.map((item) => {
          ...
          if (item.isCenter) {
            return (
              ...
              >
                <div className={`w-12 h-12 rounded-full bg-gradient-to-tr from-brand-600 to-brand-500 flex items-center justify-center text-white shadow-lg shadow-brand-500/30 transition-all duration-150 ${
          ...
          return (
            ...
            >
              <div className={`relative ${isActive ? 'after:content-[""] after:absolute after:-bottom-1 after:left-1/2 after:-translate-x-1/2 after:w-1 after:h-1 after:bg-brand-600 dark:after:bg-brand-400 after:rounded-full' : ''}`}>
